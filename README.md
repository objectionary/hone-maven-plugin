...
Size of .xmir after unphi: 3Mb (3Mb bytes, 58013 lines)
Optimization time: 22s (22134 ms)

eo-maven-plugin:phi-to-xmir   10.701  54.73%
eo-maven-plugin:xmir-to-phi   5.147   26.32%
jeo-maven-plugin:disassemble  2.073   10.60%
exec-maven-plugin:exec        1.071   5.48%
jeo-maven-plugin:assemble     0.561   2.87%
```

The results were calculated in [this GHA job][benchmark-gha]
on 2025-02-25 at 05:08,
...
[benchmark-gha]: https://github.com/objectionary/hone-maven-plugin/actions/runs/13514043418
