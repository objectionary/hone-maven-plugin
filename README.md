...
```text
wrap-bytes.xsl              1598  26.98%
normalize-bytes.xsl         1554  26.24%
wrap-method-calls.xsl       1453  24.54%
atoms-with-bound-attrs.xsl  1317  22.24%
```

The results were calculated in [this GHA job][self-benchmark-gha],
on 2025-02-05 at 06:03,
on Linux with 4 CPUs.
...
[self-benchmark-gha]: https://github.com/objectionary/hone-maven-plugin/actions/runs/13151136659
