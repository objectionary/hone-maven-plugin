...
final class Grammar {
    ...
    private static final List<String> LINES = Arrays.asList(
        ...
        "words|stage|dropWhile(s -> !s.equals(tag))",
        ...
        "pairs|stage|dropWhile(p -> p.key() < by)",
